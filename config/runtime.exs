...
#
#     PHX_SERVER=true bin/claude_p_gateway start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :claude_p_gateway, ClaudePGatewayWeb.Endpoint, server: true
end
...
config :claude_p_gateway, :gateway_token, gateway_token

if claude_bin = System.get_env("CLAUDE_BIN") do
...
if config_env() == :prod do
  ...
  config :claude_p_gateway, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
